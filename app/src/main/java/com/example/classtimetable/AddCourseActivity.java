...
public class AddCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText inputDay = (EditText) findViewById(R.id.course_week);
        final EditText inputStart = (EditText) findViewById(R.id.class_begin);
        final EditText inputEnd = (EditText) findViewById(R.id.class_ends);
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (courseName.equals("") || day.equals("") || start.equals("") || end.equals("")) {
                    Toast.makeText(AddCourseActivity.this, "基本课程信息未填写完成", Toast.LENGTH_SHORT).show();
                }
                else {
